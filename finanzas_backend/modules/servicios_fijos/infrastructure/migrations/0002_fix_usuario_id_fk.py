"""
Corrige un bug heredado de schema_finanzas.sql: servicios_fijos.usuario_id
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            sql="""
                ALTER TABLE servicios_fijos DROP CONSTRAINT servicios_fijos_usuario_id_fkey;
                ALTER TABLE servicios_fijos ADD CONSTRAINT servicios_fijos_usuario_id_fkey
