"""
Corrige un bug heredado de schema_finanzas.sql: alertas_pago.usuario_id
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            sql="""
                ALTER TABLE alertas_pago DROP CONSTRAINT alertas_pago_usuario_id_fkey;
                ALTER TABLE alertas_pago ADD CONSTRAINT alertas_pago_usuario_id_fkey
